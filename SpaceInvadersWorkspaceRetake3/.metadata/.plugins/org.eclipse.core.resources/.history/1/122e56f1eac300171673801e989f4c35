...
//		playAudio(&tankFireSoundRate, &tankFireSoundRate + tankFireSoundFrames);
	...
	///	playAudio(&alienMoveSound1_sampleRate, &alienMoveSound1_sampleRate + alienMoveSound1_length);
...
/*
	///	playAudio(&alienMoveSound2_sampleRate, &alienMoveSound2_sampleRate + alienMoveSound2_length);
	...
	///	playAudio(&alienMoveSound3_sampleRate, &alienMoveSound3_sampleRate + alienMoveSound3_length);

		//playAudio(&alienMove1SoundData, &alienMove1SoundData + alienMove1NumSamples);
		u16 iii, jjj;
		for(iii = 0; iii < 1000; iii++) {
			for(jjj = 0; jjj < 5000; jjj++) {
				//delay
			}
		}

	///	playAudio(&alienMoveSound4_sampleRate, &alienMoveSound4_sampleRate + alienMoveSound4_length);

		//playAudio(&alienMove1SoundData, &alienMove1SoundData + alienMove1NumSamples);
		u16 iiii, jjjj;
		for(iiii = 0; iiii < 1000; iiii++) {
			for(jjjj = 0; jjjj < 5000; jjjj++) {
				//delay
			}
		}
*/
